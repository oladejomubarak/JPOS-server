...
package com.celerpay.gopaynibssprovider.server.config;
...
public class Connection implements CommandLineRunner {
    ...
    public void run(String... args) {
        log.info("deploying nibssprovider connection configs");
        server.start();
    ...
    @PreDestroy
    public void stop(){
        log.info("un_deploying nibssprovider connection configs");
